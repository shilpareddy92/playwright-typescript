...
```
Error: page.goto: net::ERR_SOCKET_NOT_CONNECTED at https://naveenautomationlabs.com/opencart/index.php?route=account/register
Call log:
...
- generic [ref=e6]:
  ...
  - paragraph [ref=e8]:
    - text: The webpage at
    - strong [ref=e9]: https://naveenautomationlabs.com/opencart/index.php?route=account/register
